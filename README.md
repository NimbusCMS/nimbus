...
- 🧩 **Plugins** — a Composer-driven loader, a read-only Plugins admin page, and nine official plugins: [Markdown](https://github.com/NimbusCMS/plugin-markdown), [SEO](https://github.com/NimbusCMS/plugin-seo), [Analytics](https://github.com/NimbusCMS/plugin-analytics), [Advanced API](https://github.com/NimbusCMS/plugin-api-advanced), [Inventory](https://github.com/NimbusCMS/plugin-inventory) (ledger-based stock, agent-drivable), [Commerce](https://github.com/NimbusCMS/plugin-commerce) (orders reserving stock through Inventory), [Blog](https://github.com/NimbusCMS/plugin-blog) (per-post SEO head, RSS feed, tag archives, and syndication to Dev.to/Hashnode), [CRM](https://github.com/NimbusCMS/plugin-crm) (contacts, organizations, activities and a deal pipeline, agent-drivable) and [Storefront](https://github.com/NimbusCMS/plugin-storefront) (a themed public catalog over the Inventory item master). Plugins declare their own grantable capability, MCP tools, events, public routes, service ports and capability-gated admin pages
...
namespace** ([ADR 0014](docs/adr/0014-plugin-event-dispatch.md)) — a **grantable
